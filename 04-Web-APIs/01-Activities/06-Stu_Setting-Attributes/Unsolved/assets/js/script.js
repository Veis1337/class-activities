...
let titleMargin = document.querySelectorAll("h1");

titleMargin[0].setAttribute("style", "margin: 0; padding-left: 10px");
for (var i = 0; i < heading4.length; i++) {
    heading4[i].setAttribute("style", "color:blue; font-size: 30px");
   }